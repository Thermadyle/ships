...
PLAYER.WalkSpeed            = 240       -- How fast to move when not running
PLAYER.RunSpeed             = 480       -- How fast to move when running
...
player_manager.RegisterClass( "ship_captain", PLAYER, nil )
